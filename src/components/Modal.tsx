// could use type or Interface, some theoretical differences but here they work the same
            ...
            >
                <div className="w-full flex flex-col">
                    <div className="flex flex-row space-apart">
                        <i className="fa-solid fa-x flex justify-start m-3 bg-slate-300 p-2 rounded
                        hover:bg-slate-800 text-white h-fit"
                        onClick={ props.onClose }>
                        </i>
                    </div>
